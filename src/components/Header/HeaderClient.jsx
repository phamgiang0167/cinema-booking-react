...
export default class HeaderClient extends Component {
  render() {
    return (
      <Fragment>
        <header className="shadow-md p-4 bg-coolGray-100 text-coolGray-800 bg-opacity-40 bg-white text-black w-full z-10">
          <div className="container flex justify-between h-8 mx-auto">
            ...
            <ul className="items-stretch hidden space-x-3 lg:flex">
              <li className="flex">
                <NavLink
                  to="/"
                  className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-black h-8"
                  activeClassName="border-b-2 border-black">Home</NavLink>
              </li>
              <li className="flex">
                <NavLink
                  to="/contact"
                  className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-black h-8"
                  activeClassName="border-b-2 border-black">Contact</NavLink>
              </li>
              <li className="flex">
                <NavLink
                  to="/news"
                  className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-black h-8"
                  activeClassName="border-b-2 border-black">News</NavLink>
              </li>
              <li className="flex">
                <NavLink
                  to="/news"
