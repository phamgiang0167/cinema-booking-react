                    ...
                    <div className="max-w-md w-full space-y-8">
                        ...
                        >
                            ...
                            <p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                                <span>Ko có tài khoản?</span>
                                <Link to="/register" className="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Đăng kí</Link>
                            </p>
                        </form>
                    </div>
                </div>
