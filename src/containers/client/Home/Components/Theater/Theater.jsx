...
export default function Theater(props) {
    ...
    return (
        <div style={{ marginTop: "20px" }}>
            <div className="row" id="picker">
                <FormControl variant="outlined" className={classes.formControl + " col-sm-3"}>
            ...
            <button className="button__booking" onClick={() => history.push(`checkout/${state.date.maLichChieu}`)}>Đặt vé</button>
        </div>
    );
}
